...
from dlf.ch05.ex05_relu import Relu
from dlf.ch05.ex07_affine import Affine
from dlf.ch05.ex08_softmax_loss import SoftmaxWithLoss
...
class TwoLayerNetwork:
    def __init__(self, input_size, hidden_size, output_size,
        ...
        # layer 생성/초기화
        self.layers = OrderedDict()  # 딕셔너리에 데이터가 추가된 순서가 유지되는 딕셔너리
